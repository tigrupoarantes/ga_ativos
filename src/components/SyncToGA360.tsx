  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Sincronize empresas e funcionários com o sistema GA360
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <p className="text-xs text-muted-foreground">
          A sincronização usa CNPJ (empresas) e CPF (funcionários) como chaves únicas para identificar registros existentes no GA360.
        </p>
      </CardContent>
    </Card>
  );
